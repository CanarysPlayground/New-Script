...
class GitHubTeamFetcher:
    def __init__(self):
        ...
        self.api_url = os.getenv('TARGET_API_URL', 'https://api.github.com')
        # Remove trailing slash if present
        self.api_url = self.api_url.rstrip('/')
        
        if not self.token:
            raise ValueError("TARGET_GH_PAT environment variable is required")
        if not self.org_name:
            raise ValueError("TARGET_GH_ORG environment variable is required")
        ...
        logger.info(f"Initialized GitHub Team Fetcher for organization: {self.org_name} using API URL: {self.api_url}")
    ...
    def check_rate_limit_status(self):
        ...
        resp = self.make_api_request("GET", f"{self.api_url}/rate_limit")
    ...
    def get_teams(self):
        ...
        url = f"{self.api_url}/orgs/{self.org_name}/teams"
    ...
    def get_team_repos(self, team_slug):
        ...
        url = f"{self.api_url}/orgs/{self.org_name}/teams/{team_slug}/repos"
    ...
    def get_team_members(self, team_slug):
        ...
        # Get team info first
        team_url = f"{self.api_url}/orgs/{self.org_name}/teams/{team_slug}"
        ...
        org_members_url = f"{self.api_url}/orgs/{self.org_name}/members"
        org_members = []
        page = 1
        ...
        for member in org_members:
            ...
            membership_url = f"{self.api_url}/orgs/{self.org_name}/teams/{team_slug}/memberships/{username}"
            ...
            if membership_response.status_code == 200:
                ...
                if membership_data.get('state') == 'active':
                    ...
                    if has_parent:
                        ...
                        child_teams_url = f"{self.api_url}/orgs/{self.org_name}/teams"
                        ...
                        if child_response.status_code == 200:
                            ...
                            for child_team in child_teams:
                                ...
                                child_membership_url = f"{self.api_url}/orgs/{self.org_name}/teams/{child_slug}/memberships/{username}"
